# bench: codex-cli-panels-run2

| label | commit | idle CPU% | stream CPU% | idle+transcript CPU% | max RSS (MB) |
|---|---|---|---|---|---|
| codex-cli-panels-run2 | 6974df9 | 0.4 | 68.1 | 0.2 | 170 |
...
- cpu profile: 20260831T151548Z-codex-cli-panels-run2.sample.txt beside this file (not committed)
