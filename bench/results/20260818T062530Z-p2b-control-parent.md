# bench: p2b-control-parent

| label | commit | idle CPU% | stream CPU% | idle+transcript CPU% | max RSS (MB) |
|---|---|---|---|---|---|
| p2b-control-parent | e845593 | 0.7 | 71.6 | 0.9 | 232 |
...
- cpu profile: 20260818T062530Z-p2b-control-parent.sample.txt beside this file (not committed)
