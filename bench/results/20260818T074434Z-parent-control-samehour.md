# bench: parent-control-samehour

| label | commit | idle CPU% | stream CPU% | idle+transcript CPU% | max RSS (MB) |
|---|---|---|---|---|---|
| parent-control-samehour | 96ddf3d | 1.2 | 75.2 | 0.9 | 145 |
...
- cpu profile: 20260818T074434Z-parent-control-samehour.sample.txt beside this file (not committed)
