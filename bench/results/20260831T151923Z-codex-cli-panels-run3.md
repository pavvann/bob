# bench: codex-cli-panels-run3

| label | commit | idle CPU% | stream CPU% | idle+transcript CPU% | max RSS (MB) |
|---|---|---|---|---|---|
| codex-cli-panels-run3 | 6974df9 | 0.2 | 68.1 | 1.2 | 144 |
...
- cpu profile: 20260831T151923Z-codex-cli-panels-run3.sample.txt beside this file (not committed)
