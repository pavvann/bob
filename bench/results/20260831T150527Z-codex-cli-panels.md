# bench: codex-cli-panels

| label | commit | idle CPU% | stream CPU% | idle+transcript CPU% | max RSS (MB) |
|---|---|---|---|---|---|
| codex-cli-panels | c9bbf55 | 1.5 | 68.7 | 26.4 | 140 |
...
- cpu profile: 20260831T150527Z-codex-cli-panels.sample.txt beside this file (not committed)
